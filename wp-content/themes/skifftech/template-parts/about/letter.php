<?php
/**
 * About Us — A note from our CTO.
 *
 * @package skifftech
 */

?>
<section class="ab-section ab-section-raise">
  <div class="ab-wrap">
    <div class="ab-head reveal">
      <span class="eyebrow">A note from our CTO</span>
      <h2 class="ab-h2">Why Skiff exists.</h2>
    </div>

    <div class="ab-letter reveal">
      <div class="ph">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/images/team/mohammad-istiaque-shawn-square.jpg' ); ?>"
             alt="Mohammad Istiaque Shawn, CTO of Skiff Technologies"
