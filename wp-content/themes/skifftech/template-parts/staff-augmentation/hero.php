  ...
  <div class="sa-wrap">
    <div class="sa-hero-grid">
      <div class="reveal">
        ...
        <p class="sa-lead">Skiff Technologies offers complete staff augmentation services to extend your team with senior engineers &mdash; without the months-long hiring cycle. Our staff augmentation solutions place vetted talent directly inside your existing team: your stack, your tools, your process. You stay in charge of the roadmap; we take care of sourcing, vetting, contracts, and retention. Most roles get a shortlist within 48 hours.</p>
      ...
      <div class="sa-hero-visual reveal">
        <?php // Signature motif: team graph (inline SVG, no image asset). ?>
