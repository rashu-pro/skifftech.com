...
$skifftech_departments = array(
	...
	array(
		...
		'members' => array(
			...
			array(
				'slug'  => 'noman',
				'name'  => 'Abu Syed Mohammad Noman',
				'role'  => 'Software &amp; Data Solution Specialist',
				'exp'   => '15+ yrs',
				'image' => 'abu-syed-mohammad-noman.jpg',
				'modal' => array(
					'exp2' => '15+ years experience',
					'bio'  => array(
						'<b>Abu Syed Mohammad Noman is a data professional with 15+ years of experience across data engineering, full-stack development, and technical leadership.</b>',
						'At Skiff Technologies he leads large-scale data migration and ETL pipeline initiatives for automotive dealership clients in the USA, with hands-on expertise in Azure Data Factory, C#, Python, and SQL Server. His earlier work spans ERP system design, BI reporting, and enterprise integrations across the manufacturing, government, and technology sectors.',
					),
					'jobs' => array(
						array( 'Oct 2022 — Present', 'Software &amp; Data Solution Specialist · Skiff Technologies (Dominion DMS)', 'Leads planning and execution of large-scale data migration projects for automotive dealership clients, designs ETL pipelines in Azure Data Factory and .NET, and builds C# and Python migration tools for automated extraction, validation, and reporting.' ),
					),
					'education' => array(
						array( 'Professional Diploma in Information Technology', 'NIIT · 2006' ),
						array( 'B.S.S. in Social Science', 'Chittagong · 2012' ),
						array( 'HSC in Science', 'Chittagong Board · 2000' ),
					),
					'skills'    => array( 'Data Migration', 'ETL Pipeline Design', 'Data Quality', 'Full-Stack Development', 'Technical Leadership' ),
					'languages' => array(
						array( 'C#', 82, 'Advanced' ),
						array( 'Python', 82, 'Advanced' ),
						array( 'Django', 62, 'Intermediate' ),
						array( 'React', 62, 'Intermediate' ),
						array( 'ASP.NET Core MVC', 82, 'Advanced' ),
						array( 'JavaScript', 62, 'Intermediate' ),
						array( 'SQL Server', 100, 'Expert' ),
						array( 'MySQL', 82, 'Advanced' ),
						array( 'Oracle', 62, 'Intermediate' ),
						array( 'Azure Data Factory', 100, 'Expert' ),
						array( 'Azure', 82, 'Advanced' ),
						array( 'Git', 82, 'Advanced' ),
					),
				),
			),
		),
