  ...
  <div class="sa-wrap">
    <div class="sa-hero-grid">
      <div class="reveal">
        ...
        <span class="eyebrow">End-to-End Product Build</span>
        <h1>You bring the vision; we own delivery &mdash; <span class="gold-txt">from discovery to launch and beyond.</span></h1>
        <p class="sa-lead">One accountable partner for the whole journey: product discovery, UX and UI design, engineering, QA, launch, and what comes after. You don&rsquo;t need a technical team, a spec document, or project-management hours &mdash; you need an idea worth building. We handle the rest.</p>
      ...
      <div class="sa-hero-visual reveal">
        <?php // Signature motif: idea -> discovery -> design -> build -> launch -> beyond. ?>
