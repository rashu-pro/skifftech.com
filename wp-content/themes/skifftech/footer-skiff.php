  ...
  <div class="wrap">
    ...
    <div class="foot-top">
      ...
      <div class="foot-col">
        ...
        <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>">SaaS Development</a>
        <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>">Mobile Apps</a>
        <a href="<?php echo esc_url( home_url( '/products/' ) ); ?>">Products</a>
        <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>">Cloud &amp; DevOps</a>
      </div>
      ...
      <div class="foot-col">
        ...
        <a href="<?php echo esc_url( home_url( '/work/' ) ); ?>">Case Studies</a>
        <a href="<?php echo esc_url( home_url( '/why-skiff/' ) ); ?>">Why Skiff</a>
      ...
      <div class="foot-col">
        ...
        <a href="https://maps.google.com/?q=1103+CDA+Avenue+East+Nasirabad+Chittagong" target="_blank" rel="noopener">
          1103, CDA Avenue,<br>East Nasirabad, Chittagong
        </a>
        <a href="mailto:hello@skifftech.com">hello@skifftech.com</a>
